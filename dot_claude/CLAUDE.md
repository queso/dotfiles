...
- No em-dashes. Where one would go, use a period, a comma, or a colon.
- Do not write "it's not X, it's Y" or "X isn't the problem, Y is." State Y.
- No dramatic adverbs: quietly, silently.
- No sincerity words: honestly, genuinely, frankly, to be honest.
- Do not annotate your own emphasis: "that part matters," "here's the thing," "turns out," "the real problem is," "worth noting," "that's the whole point/trick/game."
- No depth metaphors for abstraction: "a level deeper," "a level shallower," "one layer down." Say what changes: more detail, less detail, the specific thing.
